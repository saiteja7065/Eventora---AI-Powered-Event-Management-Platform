...
import { UserPlus, Mail, Lock, User, Loader2, Github } from 'lucide-react';
            ...
            >
                <Card variant="glass">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>
                            Join Eventora and start creating amazing events
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="relative my-6">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-2 bg-bg-primary text-text-muted">Or sign up with</span>
                                </div>
                            </div>
